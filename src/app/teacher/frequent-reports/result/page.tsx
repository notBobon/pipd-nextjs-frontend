...
const mockCurriculum: CurriculumRow[] = [
  {
    name: "Mandatory E-Learning Refresher 2024 [Bahasa Indonesia]",
    type: "Mandatory OJK",
    start: "31/03/2025",
    end: "04/04/2025",
    status: "Not Started",
...
export default function FrequentReportsResultPage() {
  ...
  return (
    <div className="px-2 space-y-8">
      ...
      {/* ====== 5) Main Table ====== */}
      <div className="overflow-x-auto border border-gray-200 rounded-lg mb-40">
