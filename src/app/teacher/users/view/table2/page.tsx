  ...
  return (
    <div className="px-2">
      ...
      <div className="mb-4 flex items-center justify-between">
        <button
          className="inline-flex items-center gap-2 bg-white border border-gray-300 text-gray-700 text-sm px-3 py-1.5 rounded-md hover:bg-gray-50 h-11"
          onClick={() => {
                ...
                .map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="p-2">
                      ...
                      <button className="text-gray-700 border bg-white border-gray-500 hover:underline text-xs h-8 w-10 px-2 py-1 rounded-lg">
